...
final class RequestContext
{
	 ...
	 *
	 * @param array{type: string, component: string, file: string, line: int, basis?: string} $source Captured source attribution.
	 * @return array{
	 *   request_id: string,
	 *   source_type: string,
	...
	public function evidenceMetadata(array $source): array
	{
		return array(
			...
			'source_basis'     => 'registered-setting' === ($source['basis'] ?? '') ? 'registered-setting' : 'caller',
