...
2. Read the release version from `configops.php`, then copy the installable plugin contents into `trunk/` and the matching tag directory, for example `tags/0.3.1/`.
